...
VALUES
 ('429edb84-fef7-4b25-80a4-158e47839cdf', 'user', 'ikola', 'mavr', '$2a$10$ZoXPf4qjJf/zrZazfN62quLf3A6qXFCVuOJJvLynsYsaKVKY5pJye','ROLE_USER', true,true,true,true),
 ('fc88dc17-cadc-4b76-b894-cda88488529b', 'admin', 'reo', 'savr', '$2a$10$GMhQNJ6Fo6/IZlJfnWgnluH.YA2gWB/4EfsNzOnJwyftsv5eTEw8e','ROLE_ADMIN', true,true,true,true);
